...
export default function GheeTemplate({
  ...
  const footerBgColor = page.footer_bg_color || '#2D1B07';
  const footerTextColor = page.footer_text_color || '#fde68a';
  ...
  const footerBorderColor = page.footer_border_color || '#3f2a12';
  ...
  return (
    <>
      ...
      <div className="ghee-page min-h-screen" style={{ backgroundColor: '#FFF9F0' }}>
        ...
        <div
          ref={heroRef}
          className="relative overflow-hidden ghee-grain"
          style={{
            minHeight: '80vh',
            ...(heroBackgroundImage ? {
        ...
        >
          ...
          {!heroBackgroundImage && <div className="ghee-hero-pattern" />}
              ...
              <div className="text-center max-w-5xl mx-auto">
                <div ref={heroTextRef}>
                  ...
                  {page.hero_subtitle && page.hero_subtitle_position !== 'below-image' && (
                    <p className="text-base sm:text-lg md:text-xl mb-8 leading-relaxed text-[#5D4E37] whitespace-pre-line max-w-3xl mx-auto"
                ...
                {page.hero_button_text && (
                  <button
                    ...
                    className="ghee-btn-ripple inline-flex items-center gap-3 px-10 py-4 text-lg sm:text-xl font-bold shadow-lg hover:shadow-xl transform hover:scale-[1.03] transition-all duration-300"
                    style={{
                    ...
                    <div>
                      ...
                      <div className="rounded-2xl border border-amber-100/60 bg-gradient-to-b from-amber-50/40 to-white p-5">
                        ...
                        <button
                          ...
                          className="ghee-btn-ripple w-full mt-5 py-4 text-sm sm:text-base font-bold text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:transform-none disabled:hover:shadow-lg flex items-center justify-center gap-2"
                          style={{
                            backgroundColor: page.btn_bg_color || page.primary_color,
                            color: page.btn_text_color || '#ffffff',
                            borderColor: page.btn_border_color || 'transparent',
