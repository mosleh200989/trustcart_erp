...
import { FaPhone, FaEnvelope, FaUser, FaShoppingCart, FaHeart, FaBars, FaSearch } from 'react-icons/fa';
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Actions */}
            <div className="flex items-center gap-6">
              <Link href="/wishlist" className="flex flex-col items-center text-gray-700 hover:text-orange-500 transition">
                <FaHeart size={24} />
                <span className="text-xs mt-1">Wishlist</span>
              </Link>
              
              {user ? (
                <Link href="/customer/dashboard" className="flex flex-col items-center text-gray-700 hover:text-orange-500 transition">
                  <FaUser size={24} />
                  <span className="text-xs mt-1">My Account</span>
                </Link>
              ) : (
                <Link href="/customer/login" className="flex flex-col items-center text-gray-700 hover:text-orange-500 transition">
                  <FaUser size={24} />
