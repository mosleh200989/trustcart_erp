      ...
      <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          {loading ? (
            ...
            <div className="text-center text-gray-500">No purchase orders found</div>
          ) : (
                ...
                <tbody className="divide-y">
                  {purchases.map((purchase) => (
                    <tr key={purchase.id}>
                      ...
                      <td className="px-6 py-4">{purchase.supplier || 'N/A'}</td>
                      <td className="px-6 py-4">৳{Number(purchase.amount || 0).toFixed(2)}</td>
