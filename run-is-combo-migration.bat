@echo off
echo Running migration: Add is_combo column to products table
echo ================================================
...
psql -h %DB_HOST% -p %DB_PORT% -U %DB_USERNAME% -d %DB_DATABASE% -f "db\migrations\add-is-combo-to-products.sql"
