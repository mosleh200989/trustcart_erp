...
export class LeadManagementService {
  ...
  async getIncompleteOrdersFiltered(filters: {
    ...
    const limit = filters.limit && filters.limit > 0 ? Math.min(filters.limit, 2000) : 20;
  ...
  async getAllCustomersWithTiers(filters: {
    ...
    // Exclude them from all queries EXCEPT when explicitly filtering for rejected tier.
